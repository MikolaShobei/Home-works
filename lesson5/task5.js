...
// ==============================================
 ...
 {        
function TegProperties (tagName, action, attrs){
     this.tagName = tagName;
     this.action = action;
     this.attrs = attrs;

     this.descriptionTeg = function () {
          // debugger
          this.object = {}
          this.object.tagName = tagName;
          this.object.action = action;
          this.object.attrs = attrs
...
let attrs = [
    {
          titleOfAttr1: "accesskey", 
          actionOfAttr1: "Активация ссылки с помощью комбинации клавиш"
     }, 
     {
          titleOfAttr2: "href", 
          actionOfAttr2: "Задает адрес документа, на который следует перейти"}, 
     {
          titleOfAttr3: "shape", 
          acitonOfAttr3: "Задает форму активной области ссылки для изображений"
     },
     {
          titleOfAttr1: "accesskey", 
          actionOfAttr1: "Активация ссылки с помощью комбинации клавиш"
     ...
     {
          titleOfAttr3: "shape", 
          actionOfAttr3: "Задает форму активной области ссылки для изображений"
     },
     {
          titleOfAttr1: "align", 
          actionOfAttr1: "Определяет выравнивание заголовка"
     },
     {
          titleOfAttr1: "class", 
          actionOfAttr1: "Определяет имя класса, которое позволяет связать тег со стилевым оформлением"
     }, 
     {
          titleOfAttr2: "dir", 
          actionOfAttr2: "Задает направление и отображение текста — слева направо или справа налево"
     }, 
     {
          titleOfAttr1: "accept", 
          actionOfAttr1: "Устанавливает фильтр на типы файлов, которые вы можете отправить через поле загрузки файлов"
     },
     {
          titleOfAttr1: "accept-charset", 
          actionOfAttr1: "Устанавливает кодировку, в которой сервер может принимать и обрабатывать данные"
     }, 
     {
          titleOfAttr2: "action", 
          actionOfAttr2: "Адрес программы или документа, который обрабатывает данные формы"
     }, 
     {
          titleOfAttr3: "method", 
          actionOfAttr3: "Метод протокола HTTP"
     
     },
     {
          titleOfAttr1: "label", 
          actionOfAttr1: "Указание метки пункта списка"
     }, 
     {
          titleOfAttr2: "disabled", 
          actionOfAttr2: "Заранее устанавливает определенный пункт списка выделенным"
     }, 
     {
          titleOfAttr3: "value", 
          actionOfAttr3: "Значение пункта списка, которое будет отправлено на сервер или прочитано с помощью скриптов"
     },
     {
          titleOfAttr1: "accesskey", 
          actionOfAttr1: "Позволяет перейти к списку с помощью некоторого сочетания клавиш"
     }, 
     {
          titleOfAttr2: "autofocus", 
          actionOfAttr2: "Устанавливает, что список получает фокус после загрузки страницы"
     }, 
     {
          titleOfAttr3: "form", 
          actionOfAttr3: "Связывает список с формой"
     },
